...
public class AlternativaServiceImpl implements AlternativaService {
    ...
    List<Consulta> consultas = Arrays.asList(clienteRest.getForObject(consultaServiceUrl + "/api/consultas/listar", Consulta[].class));
    ...
    Consulta consulta = clienteRest.getForObject(consultaServiceUrl + "/api/consultas/ver/{id}", Consulta.class, pathVariables);
    ...
    ResponseEntity<Consulta> response = clienteRest.exchange(consultaServiceUrl + "/api/consultas/crear",
    ...
    public Consulta update(Consulta consulta, Long id) {
        ...
        pathVariables.put("id", id.toString());
        HttpEntity<Consulta> body = new HttpEntity<Consulta>(consulta);
    ResponseEntity<Consulta> response = clienteRest.exchange(consultaServiceUrl + "/api/consultas/editar/{id}",
    ...
    public void dropById(Long id) {
        Map<String,String> pathVariables = new HashMap<String, String>();
        pathVariables.put("id", id.toString());
    clienteRest.delete(consultaServiceUrl + "/api/consultas/eliminar/{id}", pathVariables);
    }
    ...
    public AlternativaDAO crear(AlternativaDAO alternativaDAO) {
        ...
        try {
            String url = consultaServiceUrl + "/api/consultas/ver/" + consultaId;
    ...
    public Alternativa obtenerPorId(Long id) {
        return alternativaRepository.findById(id)
            .map(altDao -> {
                ...
                try {
                    String url = consultaServiceUrl + "/api/consultas/ver/" + altDao.getConsultaId();
